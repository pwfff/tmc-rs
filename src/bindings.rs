...
pub const ConfigState_CONFIG_READY: ConfigState = 0;
pub const ConfigState_CONFIG_RESET: ConfigState = 1;
pub const ConfigState_CONFIG_RESTORE: ConfigState = 2;
...
pub struct ConfigurationTypeDef {
    ...
    pub callback: tmc_callback_config,
    pub channel: u8,
}
#[test]
...
extern "C" {
    pub fn aligned_alloc(__alignment: cty::c_uint, __size: cty::c_uint) -> *mut cty::c_void;
}
extern "C" {
    pub fn abort() -> !;
}
...
pub const TMCError_TMC_ERROR_FUNCTION: TMCError = 2;
pub const TMCError_TMC_ERROR_MOTOR: TMCError = 8;
pub const TMCError_TMC_ERROR_VALUE: TMCError = 16;
pub const TMCError_TMC_ERROR_CHIP: TMCError = 64;
pub type TMCError = cty::c_uint;
pub const TMC_Comm_Mode_TMC_COMM_DEFAULT: TMC_Comm_Mode = 0;
pub const TMC_Comm_Mode_TMC_COMM_SPI: TMC_Comm_Mode = 1;
pub const TMC_Comm_Mode_TMC_COMM_UART: TMC_Comm_Mode = 2;
pub type TMC_Comm_Mode = cty::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct TMC2240TypeDef {
    pub config: *mut ConfigurationTypeDef,
    pub velocity: i32,
    pub oldX: i32,
    pub oldTick: u32,
...
pub type tmc2240_callback =
    ::core::option::Option<unsafe extern "C" fn(arg1: *mut TMC2240TypeDef, arg2: ConfigState)>;
extern "C" {
...
extern "C" {
    pub static tmc2240_RegisterConstants: [TMCRegisterConstant; 0usize];
}
extern "C" {
    pub fn tmc2240_init(
        tmc2240: *mut TMC2240TypeDef,
        channel: u8,
        config: *mut ConfigurationTypeDef,
        registerResetState: *const i32,
    );
}
extern "C" {
    pub fn tmc2240_reset(tmc2240: *mut TMC2240TypeDef) -> u8;
}
extern "C" {
    pub fn tmc2240_restore(tmc2240: *mut TMC2240TypeDef) -> u8;
}
extern "C" {
    pub fn tmc2240_getSlaveAddress(tmc2240: *mut TMC2240TypeDef) -> u8;
}
extern "C" {
    pub fn tmc2240_setSlaveAddress(tmc2240: *mut TMC2240TypeDef, slaveAddress: u8);
}
extern "C" {
    pub fn tmc2240_setRegisterResetState(tmc2240: *mut TMC2240TypeDef, resetState: *const i32);
}
extern "C" {
    pub fn tmc2240_setCallback(tmc2240: *mut TMC2240TypeDef, callback: tmc2240_callback);
}
extern "C" {
    pub fn tmc2240_periodicJob(tmc2240: *mut TMC2240TypeDef, tick: u32);
}
extern "C" {
    pub fn tmc2240_consistencyCheck(tmc2240: *mut TMC2240TypeDef) -> u8;
}
pub const TMC_LinearRamp_Mode_TMC_RAMP_LINEAR_MODE_VELOCITY: TMC_LinearRamp_Mode = 0;
pub const TMC_LinearRamp_Mode_TMC_RAMP_LINEAR_MODE_POSITION: TMC_LinearRamp_Mode = 1;
pub type TMC_LinearRamp_Mode = cty::c_uint;
pub const TMC_LinearRamp_State_TMC_RAMP_LINEAR_STATE_IDLE: TMC_LinearRamp_State = 0;
pub const TMC_LinearRamp_State_TMC_RAMP_LINEAR_STATE_DRIVING: TMC_LinearRamp_State = 1;
pub const TMC_LinearRamp_State_TMC_RAMP_LINEAR_STATE_BRAKING: TMC_LinearRamp_State = 2;
...
pub struct TMC_LinearRamp {
    ...
    pub rampMode: TMC_LinearRamp_Mode,
    pub state: TMC_LinearRamp_State,
...
extern "C" {
    pub fn tmc_ramp_linear_init(linearRamp: *mut TMC_LinearRamp);
}
extern "C" {
    pub fn tmc_ramp_linear_compute(linearRamp: *mut TMC_LinearRamp) -> i32;
}
extern "C" {
    pub fn tmc_ramp_linear_compute_velocity(linearRamp: *mut TMC_LinearRamp) -> i32;
}
extern "C" {
    pub fn tmc_ramp_linear_compute_position(linearRamp: *mut TMC_LinearRamp);
}
extern "C" {
    pub fn tmc_ramp_linear_set_enabled(linearRamp: *mut TMC_LinearRamp, enabled: bool);
}
extern "C" {
    pub fn tmc_ramp_linear_set_maxVelocity(linearRamp: *mut TMC_LinearRamp, maxVelocity: u32);
}
extern "C" {
    pub fn tmc_ramp_linear_set_targetPosition(linearRamp: *mut TMC_LinearRamp, targetPosition: i32);
}
extern "C" {
    pub fn tmc_ramp_linear_set_rampPosition(linearRamp: *mut TMC_LinearRamp, rampPosition: i32);
}
extern "C" {
    pub fn tmc_ramp_linear_set_targetVelocity(linearRamp: *mut TMC_LinearRamp, targetVelocity: i32);
}
extern "C" {
    pub fn tmc_ramp_linear_set_rampVelocity(linearRamp: *mut TMC_LinearRamp, rampVelocity: i32);
}
extern "C" {
    pub fn tmc_ramp_linear_set_acceleration(linearRamp: *mut TMC_LinearRamp, acceleration: i32);
}
extern "C" {
    pub fn tmc_ramp_linear_set_mode(linearRamp: *mut TMC_LinearRamp, mode: TMC_LinearRamp_Mode);
}
extern "C" {
    pub fn tmc_ramp_linear_set_precision(linearRamp: *mut TMC_LinearRamp, precision: u32);
}
extern "C" {
    pub fn tmc_ramp_linear_set_homingDistance(linearRamp: *mut TMC_LinearRamp, homingDistance: u32);
}
extern "C" {
    pub fn tmc_ramp_linear_set_stopVelocity(linearRamp: *mut TMC_LinearRamp, stopVelocity: u32);
}
extern "C" {
    pub fn tmc_ramp_linear_get_enabled(linearRamp: *mut TMC_LinearRamp) -> bool;
}
extern "C" {
    pub fn tmc_ramp_linear_get_maxVelocity(linearRamp: *mut TMC_LinearRamp) -> u32;
}
extern "C" {
    pub fn tmc_ramp_linear_get_targetPosition(linearRamp: *mut TMC_LinearRamp) -> i32;
}
extern "C" {
    pub fn tmc_ramp_linear_get_rampPosition(linearRamp: *mut TMC_LinearRamp) -> i32;
}
extern "C" {
    pub fn tmc_ramp_linear_get_targetVelocity(linearRamp: *mut TMC_LinearRamp) -> i32;
}
extern "C" {
    pub fn tmc_ramp_linear_get_rampVelocity(linearRamp: *mut TMC_LinearRamp) -> i32;
}
extern "C" {
    pub fn tmc_ramp_linear_get_acceleration(linearRamp: *mut TMC_LinearRamp) -> i32;
}
extern "C" {
    pub fn tmc_ramp_linear_get_state(linearRamp: *mut TMC_LinearRamp) -> TMC_LinearRamp_State;
}
extern "C" {
    pub fn tmc_ramp_linear_get_mode(linearRamp: *mut TMC_LinearRamp) -> TMC_LinearRamp_Mode;
}
extern "C" {
    pub fn tmc_ramp_linear_get_precision(linearRamp: *mut TMC_LinearRamp) -> u32;
}
extern "C" {
    pub fn tmc_ramp_linear_get_acceleration_limit(linearRamp: *mut TMC_LinearRamp) -> u32;
}
extern "C" {
    pub fn tmc_ramp_linear_get_velocity_limit(linearRamp: *mut TMC_LinearRamp) -> u32;
}
extern "C" {
    pub fn tmc_ramp_linear_get_homingDistance(linearRamp: *mut TMC_LinearRamp) -> u32;
}
extern "C" {
    pub fn tmc_ramp_linear_get_stopVelocity(linearRamp: *mut TMC_LinearRamp) -> u32;
}
pub const TMC_RampType_TMC_RAMP_TYPE_LINEAR: TMC_RampType = 0;
pub type TMC_RampType = cty::c_uint;
extern "C" {
    pub fn tmc_ramp_init(ramp: *mut cty::c_void, type_: TMC_RampType);
}
extern "C" {
    pub fn tmc_ramp_compute(ramp: *mut cty::c_void, type_: TMC_RampType, delta: u32) -> i32;
}
extern "C" {
    pub fn tmc_ramp_get_rampVelocity(ramp: *mut cty::c_void, type_: TMC_RampType) -> i32;
}
extern "C" {
    pub fn tmc_ramp_get_rampPosition(ramp: *mut cty::c_void, type_: TMC_RampType) -> i32;
}
extern "C" {
    pub fn tmc_ramp_get_enabled(ramp: *mut cty::c_void, type_: TMC_RampType) -> bool;
}
extern "C" {
    pub fn tmc_ramp_set_enabled(ramp: *mut cty::c_void, type_: TMC_RampType, enabled: bool);
}
extern "C" {
    pub fn tmc_ramp_toggle_enabled(ramp: *mut cty::c_void, type_: TMC_RampType);
}
